...
<div class="col-md-3 col-lg-3 colg-xs-10 ">
 ...
 <video id="m"  style="margin-top: 0px; margin-left: 5px;"  controls="controls" 
 class="embed-responsive-item" height="240"  ></video>
 <br/>
...
<div class="col-md-9 col-lg-9 col-xs-10">
 ...
 <div class="embed-responsive embed-responsive-16by9">
        <video id="a"  style="margin-top: 0px;" controls="controls"  class="embed-responsive-item video" ></video>
...
<li><div id="file"></div></li>
 ...
 <div class="chat-box bg-white"><div class="input-group"> <input id="input-text-chat"  class="form-control border no-shadow no-rounded"  placeholder="Type your message here"> <span class="input-group-btn"> <button id="share-file" class="btn  no-rounded"  type="button" style="background-color: #71c9c6;
...
<div  id='file-container' class="row"></div>
<style type="text/css">
