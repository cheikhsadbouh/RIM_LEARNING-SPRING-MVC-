            ...
            connection.onFileEnd = function(file) {
               ...
               // var div = helper.div;
                if (file.type.indexOf('image') != -1) {
                   // div.innerHTML = '<a  id="d" href="' + file.url + '" download="' + file.name + '">Download <strong style="color:green;">' + file.name + '</strong> </a><br /><img  id="myimg" src="' + file.url + '" title="' + file.name + '" style="max-width: 80%;">';
                } else {
                   // div.innerHTML = '<a id="d" href="' + file.url + '" download="' + file.name + '">Download <strong style="color:green;">' + file.name + '</strong> </a><br /><iframe src="' + file.url + '" title="' + file.name + '" style="width: 80%;border: 0;height: inherit;margin-top:1em;"></iframe>';
                }
            };
